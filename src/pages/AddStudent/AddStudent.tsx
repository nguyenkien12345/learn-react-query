...
// Omit được sử dụng để loại bỏ một số thuộc tính cụ thể từ một type hay interface có sẵn.
// Loại bỏ thuộc tính 'id' từ  interface Student để tạo ra type FormStateType.
...
export default function AddStudent() {
  ...
  // Dùng currying
  // name: keyof FormStateType => name phải là một trong các key của FormStateType.
  // Hàm trả về là một hàm khác nhận một tham số là sự kiện (event) của React khi có sự thay đổi trong trường nhập liệu (<input>).
